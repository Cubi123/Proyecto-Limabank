...
def continous_interpret(df, X , y ,n_rows, n_cols, bins=10, size = 10, size_ratio = 1,alpha=1,hue_col_name=None):
...
def discrete_interpret(df, X , y ,n_rows, n_cols, size = 4, size_ratio = 1,alpha=1,hue_col_name=None, s=10):
